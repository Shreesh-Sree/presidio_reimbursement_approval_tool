          ...
          {!showEmailForm ? (
            <>
              ...
              <button
                ...
                className="w-full rounded-xl border border-[#d2d2d7] px-6 py-4 text-[15px] font-medium text-[#1d1d1f] transition-all duration-200 hover:bg-[#f5f5f7] dark:border-white/12 dark:text-[#f5f5f7] dark:hover:bg-[#2d2d2d]"
              >
