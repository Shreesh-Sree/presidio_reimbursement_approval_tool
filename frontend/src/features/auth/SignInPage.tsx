      ...
      <div className="flex flex-col items-center text-center">
        ...
        <div className="mt-8 flex flex-col gap-3">
          <button
            ...
            className="bg-white text-slate-800 font-bold px-8 py-4 rounded-full flex items-center gap-3 shadow-sm"
          >
          ...
          <button
            ...
            className="bg-[#24292f] text-white font-bold px-8 py-4 rounded-full flex items-center gap-3"
          >
